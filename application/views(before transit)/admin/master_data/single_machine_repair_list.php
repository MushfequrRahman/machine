<script>
  $(function() {
    ...
    $("#downloadExcel").on("click", function() {
      ...
      XLSX.writeFile(wb, 'single_machine_repair_list.xlsx');
    });
  });
</script>
              ...
              <div class="col-md-12">
                <div class="box box-danger">
                  <div class="box-header with-border">
                    <h3 class="box-title">Machine Repair List</h3>
                  </div>
                  <div class="box-body">
                    <div class="row">
                      <div class="col-md-12">
                      ...
                      <table id="tableData" class="table table-hover table-bordered">
                        <thead style="background:#91b9e6;">
                          <tr>
                            ...
                            <th data-column="1"><label class="checkbox-inline"><input type="checkbox" class="column-select" data-col-index="2" checked><strong>RF.ID</strong></label></th>
                            <th data-column="2"><label class="checkbox-inline"><input type="checkbox" class="column-select" data-col-index="3" checked><strong>Repair Price</strong></label></th>
                            <th data-column="3"><label class="checkbox-inline"><input type="checkbox" class="column-select" data-col-index="4" checked><strong>Repair Date</strong></label></th>
                            <th data-column="4"><label class="checkbox-inline"><input type="checkbox" class="column-select" data-col-index="5" checked><strong>Repair Remarks</strong></label></th>
                        ...
                        <tbody>
                          ...
                          foreach ($ul as $row) { ?>
                            <tr>
                              ...
                              <td style="vertical-align:middle;"><?php echo date("d-m-Y", strtotime($row['repairdate'])); ?></td>
                              <td style="vertical-align:middle;"><?php echo $row['repairremarks']; ?></td>
                            </tr>
                          <?php } ?>
                        </tbody>
                      </table>
