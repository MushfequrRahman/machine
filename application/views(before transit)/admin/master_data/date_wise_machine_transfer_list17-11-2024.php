    ...
    <table id="tableData" class="table table-hover table-bordered">
      <thead style="background:#91b9e6;">
        <tr>
          ...
          <th title="Status" data-column="12"><label class="checkbox-inline"><input type="checkbox" class="column-select" data-col-index="13" checked><strong>Status</strong></label></th>
        </tr>
      </thead>
      <tfoot>
        <tr>
