                    ...
                    <form role="form" autocomplete="off" action="<?php echo base_url(); ?>Dashboard/multiple_machine_rent_insert" method="post" enctype="multipart/form-data">
                      <div class="row">
                        <div class="col-md-4">
                          ...
                          <input type="text" class="form-control" name="cfactoryid" id="cfid" readonly value="<?php echo $this->session->userdata('factoryid'); ?>">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-2">
                          <label>Additional Cost<em>*</em></label>
                          <input type="text" class="form-control rd" name="ad" id="ad" placeholder="Enter Additional Cost" value="<?php echo set_value('ad'); ?>">
