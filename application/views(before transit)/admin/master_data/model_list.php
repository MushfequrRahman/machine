<script>
  $(function() {
    ...
    $("#downloadExcel").on("click", function() {
      ...
      XLSX.writeFile(wb, 'machine_name.xlsx');
    });
  });
</script>
              ...
              <div class="col-md-12">
                <div class="box box-danger">
                  <div class="box-header with-border">
                    <h3 class="box-title">Machine Model List</h3>
                  </div>
                  <div class="box-body">
                    <div class="row">
                      <div class="col-md-12">
                      ...
                      <table id="tableData" class="table table-hover table-bordered">
                        <thead style="background:#91b9e6;">
                          <tr>
                            ...
                            <th data-column="1"><label class="checkbox-inline"><input type="checkbox" class="column-select" data-col-index="2" checked><strong>Purpose</strong></label></th>
                            <th data-column="2"><label class="checkbox-inline"><input type="checkbox" class="column-select" data-col-index="3" checked><strong>Code</strong></label></th>
                            <th data-column="3"><label class="checkbox-inline"><input type="checkbox" class="column-select" data-col-index="4" checked><strong>Name</strong></label></th>
                            <th data-column="3"><label class="checkbox-inline"><input type="checkbox" class="column-select" data-col-index="5" checked><strong>Model</strong></label></th>
                            <th data-column="4"><label class="checkbox-inline"><input type="checkbox" class="column-select" data-col-index="6" checked><strong>Details</strong></label></th>
                          </tr>
                        </thead>
                        <tfoot>
                          <tr>
