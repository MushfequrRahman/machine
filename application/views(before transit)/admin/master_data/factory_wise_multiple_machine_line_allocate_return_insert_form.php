              ...
              <div class="col-md-12">
                <div class="box box-danger">
                  <div class="box-header with-border">
                    <h3 class="box-title">Machine Line Free Insert</h3>
                    <div class="row">
                  ...
                  <div class="box-body ">
                    <form role="form" autocomplete="off" action="<?php echo base_url(); ?>Dashboard/multiple_machine_allocate_line_return_insert" method="post" enctype="multipart/form-data">
