<script>
  $(function() {
    ...
    $("#downloadExcel").on("click", function() {
      ...
      XLSX.writeFile(wb, 'single_machine_rent_list.xlsx');
    });
  });
</script>
              ...
              <div class="col-md-12">
                <div class="box box-danger">
                  <div class="box-header with-border">
                    <h3 class="box-title">Machine Rent List</h3>
                  </div>
                  <div class="box-body">
                    <div class="row">
                      <div class="col-md-12">
                      ...
                      <table id="tableData" class="table table-hover table-bordered">
                        <thead style="background:#91b9e6;">
                          <tr>
                            ...
                            <th data-column="1"><label class="checkbox-inline"><input type="checkbox" class="column-select" data-col-index="2" checked><strong>SF.ID</strong></label></th>
                            <th data-column="2"><label class="checkbox-inline"><input type="checkbox" class="column-select" data-col-index="3" checked><strong>DF.ID</strong></label></th>
                            <th data-column="3"><label class="checkbox-inline"><input type="checkbox" class="column-select" data-col-index="4" checked><strong>Rent Days</strong></label></th>
                            <th data-column="4"><label class="checkbox-inline"><input type="checkbox" class="column-select" data-col-index="5" checked><strong>Rent Price</strong></label></th>
                            <th data-column="5"><label class="checkbox-inline"><input type="checkbox" class="column-select" data-col-index="6" checked><strong>Rent Date</strong></label></th>
                            <th data-column="6"><label class="checkbox-inline"><input type="checkbox" class="column-select" data-col-index="7" checked><strong>Re.Remarks</strong></label></th>
                            <th data-column="7"><label class="checkbox-inline"><input type="checkbox" class="column-select" data-col-index="8" checked><strong>Return Date</strong></label></th>
                            <th data-column="8"><label class="checkbox-inline"><input type="checkbox" class="column-select" data-col-index="9" checked><strong>Return Remarks</strong></label></th>
                            <th data-column="9"><label class="checkbox-inline"><input type="checkbox" class="column-select" data-col-index="10" checked><strong>Status</strong></label></th>
                          </tr>
                        </thead>
                        <tfoot>
                          <tr>
                        ...
                        <tbody>
                          ...
                          foreach ($ul as $row) { ?>
                            <tr>
                              ...
                              <td style="vertical-align:middle;"><?php echo $row['rentremarks']; ?></td>
                              <td style="vertical-align:middle;"><?php echo date("d-m-Y", strtotime($row['retrdate'])); ?></td>
                              <td style="vertical-align:middle;"><?php echo $row['rentreturnremarks']; ?></td>
                              <?php
                              if ($row['mistatus'] == '0') {
                              ?>
                                <td style="vertical-align:middle;">Return</td>
                              <?php
                              } else {
                              ?>
