              ...
              <div class="col-md-12">
                <div class="box box-danger">
                  <div class="box-header with-border">
                    <h3 class="box-title">Machine IN Transit</h3>
                    <div class="row">
                  ...
                  <div class="box-body ">
                    <form role="form" autocomplete="off" action="<?php echo base_url(); ?>Dashboard/multiple_machine_intransit_receive" method="post" enctype="multipart/form-data">
                      <div class="form-group">
                        <label>Receive Date<em>*</em></label>
                        <input type="text" class="form-control pd" readonly name="receivedate" value="<?php echo date('d-m-Y'); ?>">
                        <?php /*?><?php echo form_error('dobdate', '<div class="error">', '</div>');  ?><?php */ ?>
                      </div>
                      <div class="form-group">
                        <label>Remarks</label>
                        <textarea class="form-control" name="receiveremarks" rows="5" id="receiveremarks"></textarea>
                      </div>
                          ...
                          <tbody>
                            ...
                            foreach ($ul as $row) { ?>
                              <tr>
                                ...
                                <!-- <td style="vertical-align:middle;display: none;"><input type="checkbox" class="item-checkbox" name="macode[]" value="<?php echo $row['macode']; ?>"></td>
                                ...
                                <td style="vertical-align:middle;"><input type="checkbox" class="item-checkbox" name="pfactoryid[]" value="<?php echo $row['pfactoryid']; ?>"></td>
                              </tr>
                            <?php } ?>
                          </tbody>
                        </table>
