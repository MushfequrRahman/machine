              ...
              <div class="col-md-12">
                <div class="box box-danger">
                  <div class="box-header with-border">
                    <h3 class="box-title">Machine Repair Return Insert</h3>
                    <div class="row">
                  ...
                  <div class="box-body ">
                    <form role="form" autocomplete="off" action="<?php echo base_url(); ?>Dashboard/multiple_machine_repair_return_insert" method="post" enctype="multipart/form-data">
                      ...
                      <!-- <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="price" placeholder="Enter Repair Price">
                      </div> -->
                      <!-- <div class="form-group">
                        <label>Remarks</label>
                        ...
                        <table id="tableData" class="table table-hover table-bordered">
                          <thead style="background:#91b9e6;">
                            <tr>
                              ...
                              <th style="display: none;"></th>
                              <th style="display: none;"></th> -->
                              <th>Repair Factory</th>
                              <th>Asset Code</th>
                              <th>Machine Code</th>
                              <th>Name</th>
                              <th>Type</th>
                              <th class="filter-false">Repair Price</th>
                              <th class="filter-false">Remarks</th>
                          ...
                          <tbody>
                            ...
                            foreach ($ul as $row) { ?>
                              <tr>
                                ...
                                <td style="vertical-align:middle;"><input type="text" class="form-control" name="price[]" placeholder="Enter Repair Price"></td>
                                <td style="vertical-align:middle;"><textarea class="form-control" name="returnremarks[]" rows="1" id="returnremarks"></textarea></td>
