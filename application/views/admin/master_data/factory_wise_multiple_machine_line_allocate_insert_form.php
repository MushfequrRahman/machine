              ...
              <div class="col-md-12">
                <div class="box box-danger">
                  <div class="box-header with-border">
                    <h3 class="box-title">Line Wise Machine Allocate</h3>
                    <div class="row">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-2">
                          ...
                          <select class="form-control" name="slnid" id="slnid">
                            ...
                            foreach ($sl as $row) {
                            ?>
                              <option value="<?php echo $row['slnid']; ?>" <?php echo set_select('slnid', $row['slname']); ?>><?php echo $row['slname']; ?></option>
                            <?php
                            }
                            ?>
                          </select>
    ...
    <script>
      $(document).ready(function() {
        $("#mpid").change(function(event) {
          ...
          $.ajax({
            type: 'post',
            url: '<?php echo base_url(); ?>Dashboard/purpose_wise_line_allocate_machine_inventory',
            dataType: "text",
            data: {
              mpid: mpid,
