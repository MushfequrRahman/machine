...
<script>
  $(function() {
    ...
    $('th[data-hidden-column="true"], td:nth-child(15)').addClass('hidden-column');
    $('th[data-hidden-column="true"], td:nth-child(16)').addClass('hidden-column');
    $('th[data-hidden-column="true"], td:nth-child(17)').addClass('hidden-column');
    $('th[data-hidden-column="true"], td:nth-child(18)').addClass('hidden-column');
    $('th[data-hidden-column="true"], td:nth-child(19)').addClass('hidden-column');
    $('th[data-hidden-column="true"], td:nth-child(20)').addClass('hidden-column');
    // $('th[data-hidden-column="true"], td:nth-child(21)').addClass('hidden-column');
    // $('th[data-hidden-column="true"], td:nth-child(22)').addClass('hidden-column');
  });
</script>
    ...
    <tbody>
      ...
      foreach ($ul as $row) { ?>
        <tr>
          ...
          <td style="vertical-align:middle;"><input type="checkbox" class="item-checkbox" name="mcode[]" value="<?php echo $row['mcode']; ?>"></td>
          <td style="vertical-align:middle;"><input type="checkbox" class="item-checkbox" name="mtid[]" value="<?php echo $row['mtid']; ?>"></td>
          <td style="vertical-align:middle;"><input type="checkbox" class="item-checkbox" name="monid[]" value="<?php echo $row['monid']; ?>"></td>
          <td style="vertical-align:middle;"><input type="checkbox" class="item-checkbox" name="mpid" value="<?php echo $row['mpid']; ?>"></td>
          <td style="vertical-align:middle;"><input type="checkbox" class="item-checkbox" name="supplierid[]" value="<?php echo $row['supplierid']; ?>"></td>
          <td style="vertical-align:middle;"><input type="checkbox" class="item-checkbox" name="brandid[]" value="<?php echo $row['brandid']; ?>"></td>
          <td style="vertical-align:middle;"><input type="checkbox" class="item-checkbox" name="warranty[]" value="<?php echo $row['warranty']; ?>"></td>
          <td style="vertical-align:middle;"><input type="checkbox" class="item-checkbox" name="description[]" value="<?php echo $row['description']; ?>"></td>
          <td style="vertical-align:middle;"><input type="checkbox" class="item-checkbox" name="sfactoryid" value="<?php echo $sfactoryid; ?>"></td>
          <!-- <td style="vertical-align:middle;"><input type="checkbox" class="item-checkbox" name="slnid" value="<?php echo $slnid; ?>"></td> -->
          <td style="vertical-align:middle;"><input type="checkbox" class="item-checkbox" name="adate" value="<?php echo $adate; ?>"></td>
          <td style="vertical-align:middle;"><input type="checkbox" class="item-checkbox" name="price" value="<?php echo $price; ?>"></td>
