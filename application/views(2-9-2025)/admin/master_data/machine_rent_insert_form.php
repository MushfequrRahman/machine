            ...
            <div class="row">
              <div class="col-md-12">
                <div class="box box-danger">
                  ...
                  <div class="box-body ">
                    <form role="form" autocomplete="off" action="<?php echo base_url(); ?>Dashboard/machine_rent_insert" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control rd" name="rd" placeholder="Enter Rent Days" value="<?php echo set_value('rd'); ?>">
                        <?php echo form_error('mcode', '<div class="error">', '</div>');  ?>
                      </div>
                      <div class="form-group">
                        <label>Rent Price<em>*</em></label>
                        <input type="text" class="form-control rp" name="rp" placeholder="Enter Rent Price" value="<?php echo set_value('rp'); ?>">
                        <?php echo form_error('rp', '<div class="error">', '</div>');  ?>
                      </div>
                      <div class="form-group">
                          <label>Given Date<em>*</em></label>
                          <input type="text" class="form-control pd" readonly name="rentdate" value="<?php echo date('d-m-Y'); ?>">
