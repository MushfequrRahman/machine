  ...
  <table id="tableData" class="table table-hover table-bordered">
    ...
    <tbody>
      ...
      foreach ($ul as $row) { ?>
        <tr>
          <?php
          if($row['mistatus']=='1' && ($rfactoryid == $row['pfactoryid'])) 
          {
            ?>
            <td style="vertical-align:middle;"><input type="checkbox" class="check-all" disabled name="macode[]" value="<?php echo $row['macode']; ?>"><?php echo $i++; ?></td>
            <?php
          }
          else{
            ?>
          ...
          <td style="vertical-align:middle;"><input type="checkbox" class="item-checkbox" name="rfactoryid" value="<?php echo $rfactoryid; ?>"></td>
