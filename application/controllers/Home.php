...
//        }
	...
	public function provision_period_send()
	{
		...
		$query="SELECT user.factoryid,userid,ename,departmentname,echilddesignation,doj,pperiod,pperiod_status FROM user
				...
				WHERE (pperiod_status='1' OR pperiod_status='2') AND service_type!='3'";
		$result=$this->db->query($query);
		$result=$result->result_array();
